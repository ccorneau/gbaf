...
if (isset($_SESSION['username'])) {
    ...
    <div class="container_info_acteur">
        ...
        <?php     
            ...
            if (!$newCommentaire){?>
                <button id="newButton" onclick="viewButton()">Nouveau commentaire</button>
                <script>
                    function viewButton() {
    ...
    <div class="card commentaire" id="new_commentaire">
    ...
    <div class="card commentaire">
        <article class="card-body">
            <p><strong>Publié par : <?php echo $commentaires['prenom']; ?></strong><br> le
